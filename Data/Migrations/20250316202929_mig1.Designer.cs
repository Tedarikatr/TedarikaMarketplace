...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Categorys.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Categorys.CategorySub", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Stores.Store", b =>
                {
                    ...
                    b.Property<string>("AccountingIntegration")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entity.Stores.StoreCarrier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Stores.StoreInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Stores.StoreMarket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Stores.StoreProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Stores.StoreProductMarket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Stores.StoreProductShippingRegion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Categorys.CategorySub", b =>
                {
                    b.HasOne("Entity.Categorys.Category", "MainCategory")
            ...
            modelBuilder.Entity("Entity.Products.Product", b =>
                {
                    b.HasOne("Entity.Categorys.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Entity.Categorys.CategorySub", "CategorySub")
                        .WithMany()
            ...
            modelBuilder.Entity("Entity.Stores.StoreProductMarket", b =>
                {
                    ...
                    b.HasOne("Entity.Stores.StoreProduct", "StoreProduct")
